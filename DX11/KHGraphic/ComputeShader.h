...
inline void ComputeShader::SetSamplerState(Hash_Code hash_code, ID3D11SamplerState** sampler)
{
	// 해당 Value 찾기..
...
template<typename T>
void ComputeShader::SetShaderResourceView(ID3D11ShaderResourceView** srv)
{
	// 해당 Value 찾기..
