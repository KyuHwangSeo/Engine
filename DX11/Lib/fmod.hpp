    ...
    */
    ...
    class System
    {
      ...
      public:
        ...
        FMOD_RESULT F_API createSound            (const char *name_or_data, FMOD_MODE mode, FMOD_CREATESOUNDEXINFO *exinfo, Sound **gSound);
        FMOD_RESULT F_API createStream           (const char *name_or_data, FMOD_MODE mode, FMOD_CREATESOUNDEXINFO *exinfo, Sound **gSound);
        ...
        FMOD_RESULT F_API playSound              (FMOD_CHANNELINDEX channelid, Sound *gSound, bool paused, Channel **channel);
        ...
        FMOD_RESULT F_API recordStart            (int id, Sound *gSound, bool loop);
    ...
    */
    class DSPConnection
    {
      ...
      public:
        ...
        FMOD_RESULT F_API getInput              (DSP **gInput);
